...
## Доп 1. Частичная реализация функции sprintf
...
## Доп 2. Реализация некоторых модификаторов формата функции sprintf
...
## Доп 3. Реализация функции sscanf
...
## Доп 4. Реализация специальных функций обработки строк
