...
START_TEST(sscanf_spec_hhi_oct_8) {
  char format[] = "%hhi %hhi %hhi %hhi";
  char str[] =
      "01777777777777777 +0200000000000000 "
      "-0200000000000000 -0200000000000001";
  unsigned char d1, d2;
  unsigned char q1, q2;
  unsigned char z1, z2;
  unsigned char w1, w2;
...
START_TEST(sscanf_spec_hhi_hex_8) {
  char format[] = "%hhi %hhi %hhi %hhi";
  char str[] =
      "0xFFFFFFFFFFF 0x8000000000 -0xFFFFFFFFFFF "
      "-0x3489238484289328";
  unsigned char d1, d2;
  unsigned char q1, q2;
  unsigned char z1, z2;
...
START_TEST(sscanf_spec_hi_oct_8) {
  char format[] = "%hi %hi %hi %hi";
  char str[] =
      "01777777777777777 +02000000000000000 "
      "-0200000000000000 -0200000000000001";
  unsigned short d1, d2;
  unsigned short q1, q2;
  unsigned short z1, z2;
...
START_TEST(sscanf_spec_hi_hex_8) {
  char format[] = "%hi %hi %hi %hi";
  char str[] =
      "0xFFFFFFFFFFFFFFF 0x80000000000000 -0xFFFFFFFFFFFF "
      "-0x34892384889328";
  unsigned short d1, d2;
  unsigned short q1, q2;
  unsigned short z1, z2;
...
START_TEST(sscanf_spec_i_oct_8) {
  char format[] = "%i %i %i %i";
  char str[] =
      "0177777777777777777 +020000000000000000 "
      "-020000000000000 -02000000000000001";
  unsigned int d1, d2;
  unsigned int q1, q2;
  unsigned int z1, z2;
  unsigned int w1, w2;
...
START_TEST(sscanf_spec_i_hex_8) {
  char format[] = "%i %i %i %i";
  char str[] =
      "0xFFFFFFFFFFFFFF 0x8000000000000 -0xFFFFFFFFFFFF "
      "-0x3489238482389328";
  unsigned int d1, d2;
  unsigned int q1, q2;
  unsigned int z1, z2;
...
START_TEST(sscanf_spec_li_oct_8) {
  char format[] = "%li %li %li %li";
  char str[] =
      "0177777777777777777 +0200000000000000 "
      "-0200000000000000000 -020000000000001";
  unsigned long int d1, d2;
  unsigned long int q1, q2;
  unsigned long int z1, z2;
  unsigned long int w1, w2;
...
START_TEST(sscanf_spec_li_hex_8) {
  char format[] = "%li %li %li %li";
  char str[] =
      "0xFFFFFFFFFFFFFF 0x800000000000 -0xFFFFFFFFFFFFF "
      "-0x34892384889328";
  unsigned long int d1, d2;
  unsigned long int q1, q2;
  unsigned long int z1, z2;
...
START_TEST(sscanf_spec_lli_oct_8) {
  char format[] = "%lli %lli %lli %lli";
  char str[] =
      "017777777777777 +02000000000000000 "
      "-020000000000000 -020000000000001";
  unsigned long long int d1, d2;
  unsigned long long int q1, q2;
  unsigned long long int z1, z2;
  unsigned long long int w1, w2;
